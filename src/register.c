            ...
            GameAdjustmentType *adjustType) 
{
  ...
  {
    case gameLayoutBoard:
         {
           switch (adjustType->data.layoutBoard.gameBoardStyle)
           {
             case LAYOUT_TEMPLATE:
                  break;

             case LAYOUT_DIAMONDS:

                  adjustType->data.layoutBoard.Matrix[1*9+1].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+1].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5*9+6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+7].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+7].Status=HOLE;

/*
 * THIS IS WHAT WE REALLY WANT
 *
                  adjustType->data.layoutBoard.Matrix[1][1].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][1].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5][6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][7].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][7].Status=HOLE;
*/
                  (*adjustType->data.layoutBoard.maxScore) -= 16;
                  break;

             case LAYOUT_HEXMADNESS:

                  adjustType->data.layoutBoard.Matrix[1*9+0].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8*9+6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+8].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+6].Status=HOLE;
 ...
 * THIS IS WHAT WE REALLY WANT
 *
                  adjustType->data.layoutBoard.Matrix[1][0].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8][6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][8].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][6].Status=HOLE;
*/
                  (*adjustType->data.layoutBoard.maxScore) -= 11;
                  break;

             case LAYOUT_BRIDGE:

                  adjustType->data.layoutBoard.Matrix[1*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8*9+6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+6].Status=HOLE;

/*
 * THIS IS WHAT WE REALLY WANT
 *
                  adjustType->data.layoutBoard.Matrix[1][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8][6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[3][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[5][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][6].Status=HOLE;
*/             

                  (*adjustType->data.layoutBoard.maxScore) -= 12;
                  break;
 ...
 *
                  ...
                  adjustType->data.layoutBoard.Matrix[8][6].Status=HOLE;
*/             
                  (*adjustType->data.layoutBoard.maxScore) -= 7;
                  break;

             case LAYOUT_CROSS:

                  adjustType->data.layoutBoard.Matrix[2*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4*9+4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+5].Status=HOLE;
 ...
 *
                  adjustType->data.layoutBoard.Matrix[2][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4][4].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[4][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][5].Status=HOLE;
*/            
                  (*adjustType->data.layoutBoard.maxScore) -= 5;
                  break;

             case LAYOUT_HEXTOMAX:
...
*/             
                  ...
                  (*adjustType->data.layoutBoard.maxScore) -= 9;
                  break;
             
             case LAYOUT_HOURGLASS:

                  adjustType->data.layoutBoard.Matrix[0*9+1].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1*9+2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2*9+3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7*9+6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8*9+5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8*9+6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8*9+7].Status=HOLE;

/*
 * THIS IS WHAT WE REALLY WANT
 *
                  adjustType->data.layoutBoard.Matrix[0][1].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[0][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1][2].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[1][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[2][3].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[6][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[7][6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8][5].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8][6].Status=HOLE;
                  adjustType->data.layoutBoard.Matrix[8][7].Status=HOLE;
*/             
                  (*adjustType->data.layoutBoard.maxScore) -= 12;
                  break;
             
             case LAYOUT_FINALFRONTIER:
 ...
 *
                  ...
                  adjustType->data.layoutBoard.Matrix[8][7].Status=HOLE;
*/
                  (*adjustType->data.layoutBoard.maxScore) -= 18;
                  break;
